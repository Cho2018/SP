...
int count = 0;
    try {
        ...
        ResultSet rs = stmt.executeQuery( "select correct_ans from question where q_id = 302; ");
        if (rs.next()) {
           correct_ans = rs.getString("correct_ans");
           request.setAttribute( "correct_ans", correct_ans);
        }

        ResultSet rs2 = stmt.executeQuery( "select u_ans from sol where id = '" + userID + "' and q_id = " + 302 + "; ");
        if (rs2.next()) {
...
out.println(correct_ans);
        ...
        try {
            conn.close();
                                                      ...
                                                      <form method="post" action="explain/Ch3exp.jsp">
