...
<html>
	<head>
		<title>Chapter 10 Explanation</title>
		<meta charset="euc-kr" />
		...
		<%
			...
			<!-- Main -->
				<section id="main" class="container">
					<header>
						<h2>Chapter 10. 예외 처리와 제네릭 프로그래밍</h2>
					...
					<div class="box">
						<form method="post" action="#">
                                                                        	...
                                                                        	<h4>1. 제네릭 클래스에 기초 타입을 적용할 수 없다. (O, X) </h4>
                                                                           	<div class="col-6 col-12-mobilep">
						<p> 정답 : <strong> O </strong> <br>
						해설 : 제네릭 클레스에서는 타입 매개 변수를 사용한다. </p>
						</div><br>			
